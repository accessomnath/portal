         ...
         <div class="col-md-12">
            <div class="card">
               <div class="card-header" data-background-color="purple">
                  <h4 class="title">Add Aircraft to <?php echo $operator->name;?></h4>
                  <p class="category">For Operator </p>
               </div>
               <div class="card-content">
                  <form method="post" enctype="multipart/form-data"  action="<?php echo site_url('register_aircraft/add_new_aircraft');?>" class="register-aircraft">
