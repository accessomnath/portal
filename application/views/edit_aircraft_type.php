         ...
         <div class="col-md-12 col-xs-12 col-sm-12">
            <div class="card">
               <div class="card-header" data-background-color="purple">
                  <h4 class="title">Update Aircraft Type</h4>
                  <p class="category">For <?php echo $aircraft_type->name;?></p>
               </div>
               <div class="card-content">
                  <form method="post" class="update_aircraft_type">
                     <div class="row">
                        <div class="col-md-12 col-xs-12 col-sm-12">
                           <div class="form-group label-floating is-focused">
                              <label class="control-label">Aircraft Type<span class="imp">*</span></label>
                              <input type="hidden" name="id" value="<?php echo $aircraft_type->id;?>">
                              <input type="text" class="form-control" name="name" value="<?php echo $aircraft_type->name;?>" required>
