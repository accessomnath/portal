         ...
         <div class="col-md-12 col-xs-12 col-sm-12">
            <div class="card">
               <div class="card-header" data-background-color="purple">
                  <h4 class="title">Add New Operator Representative</h4>
                  <p class="category">Complete this profile</p>
               </div>
               <div class="card-content">
                  <form method="post" id="add_operator">
                     <div class="row">
                        <div class="col-md-2 col-xs-12 col-md-12">
                           <div class="form-group label-floating">
                              <label class="control-label">Operator ID</label>
                              <input type="text" class="form-control operator-id" value="000<?php echo $max;?>" readonly="readonly">
                              <span class="material-input"></span>
                           </div>
                        </div>
                        <div class="col-md-5 col-xs-12 col-sm-12">
                           <div class="form-group label-floating is-empty">
                              <label class="control-label">Operator Name <span class="imp">*</span></label>
                       ...
                       <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                           <div class="form-group label-floating">
                              ...
                              <select class="form-control" name="prefer_contact">
                     ...
                     <div class="row">
                        <div class="col-md-12">
                           <div class="form-group label-floating">
                              <label class="control-label">Operator Relation in Percentage</label>
                              <input type="number" class="form-control" name="relation">
                              <span class="material-input"></span>
                           </div>
                        </div>
                     </div>
