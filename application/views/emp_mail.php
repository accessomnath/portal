...
<html lang="en"><head>
   ...
   <title>Tam Aviation Employee Registration</title></head>
...
<div id="container">
   ...
   <h1 class="center">Employee Registration Tam Private Aviation </h1>

   <h4 class="center">Thank You For Registering</h4>
   ...
   <div id="body">
      ...
      <table border="1" style="width: 100%;">
        ...
        <thead>
          ...
          <tr><td style="width: 50%;"><h3 class="center">Username</h3></td>

              <td style="width: 50%;"><h3 class="center">Password</h3></td>
        ...
        <tbody>
          ...
          <tr><td><h3 class="center"><?php echo $emp->email;?></h3></td>

              <td><h3 class="center"><?php echo $pass;?></h3></td>
