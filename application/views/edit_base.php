         ...
         <div class="col-md-12 col-xs-12 col-sm-12">
            <div class="card">
               <div class="card-header" data-background-color="purple">
                  <h4 class="title">Edit <?php echo $aircraft->aircraft_base;?></h4>
                  <p class="category"></p>
               </div>
               <div class="card-content">
                  <form method="post" class="update_aircraft_base">
                     <div class="row">
                        <div class="col-md-12 col-xs-12 col-sm-12">
                           <div class="form-group label-floating is-focused">
                              <label class="control-label">Aircraft Name <span class="imp">*</span></label>
                              <input type="text" class="form-control" name="aircraft_base" value="<?php echo $aircraft->aircraft_base;?>" required>
